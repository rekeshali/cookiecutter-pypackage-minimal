...
# -*- coding: utf-8 -*-
#
# {{ cookiecutter.package_slug }} documentation build configuration file, created by
...
htmlhelp_basename = '{{ cookiecutter.package_slug }}doc'
...
man_pages = [
    (master_doc, '{{ cookiecutter.package_slug }}',
     u'{{ cookiecutter.package_name }} Documentation',
     [author], 1)
]
